...
namespace Sufficit.Gateway.Zabbix
{
    ...
    public class ZabbixAlertExecution
    {
        ...
        /// <summary>
        /// Stable localization key from <see cref="ZabbixGatewayMessageCodes"/> for a failed execution.
        /// Null means the execution has no coded terminal error.
        /// </summary>
        ...
        /// <summary>
        /// Optional English technical fallback for a failed execution.
        /// Frontends should localize <see cref="ErrorCode"/> instead of displaying this value when a translation exists.
        /// </summary>
